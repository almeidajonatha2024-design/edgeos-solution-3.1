# This .spec config file tells Buildozer an app's req7uirements for being built.
#
# It largely follows the syntax of an .ini file.                                   # See the end of the file for more details and warnings about common mistakes.
                                                                                   [app]
...
# (list) List of directory to exclude (leave empty to not exclude anything)        #source.exclude_dirs = tests, bin, venv
...
# (android.build_mode) The build mode (debug or release)
...
# ========================================================
# EDGEOS SOLUTIONS v3.1 - CONFIRMED ARCHITECTURE UPGRADE
# ========================================================
